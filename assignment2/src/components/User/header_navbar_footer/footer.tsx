const Footer = () => {
    return (
        <footer className="w-5/6 container mx-auto">
            <div className="text-[#444444] font-normal lg:text-[15px] sm:text-[12px] leading-[22px] grid grid-cols-4">
                <div>
                    <h4 className="text-[16px]">Tìm cửa hàng</h4>
                ...
                <div>
                    ...
                    <h4 className="text-[16px]">Đối tác dịch vụ bảo hành</h4>
                    <p>Điện Thoại - Máy tính</p>
                    <p className="text-[16px]">Trung tâm bảo hành uỷ quyền Apple</p>
            ...
            <div className="mt-10 font-normal text-[10px] leading-[20px] text-[#444444]  bg-[#F8F8F8] h-[168px]">
